...
Official source: https://refactoring.com/catalog/replaceSuperclassWithDelegate.html

## Description

Replace inheritance with delegation when reuse is the only reason for the relationship.
